...
namespace SbPy {
    ...
    static PyObject *playerMessage(PyObject *self, PyObject *args) {
        ...
        char *text;
        server::clientinfo *ci;
        if(!PyArg_ParseTuple(args, "is", &cn, &text)) return 0;
    ...
    static PyObject *spectate(PyObject *self, PyObject *args) {
        int spectator;
        server::clientinfo *ci;
        if(!PyArg_ParseTuple(args, "i", &spectator)) return 0;
    ...
    static PyObject *setPlayerTeam(PyObject *self, PyObject *args) {
        ...
        char *team;
        server::clientinfo *ci;
        if(!PyArg_ParseTuple(args, "is", &cn, &team)) return 0;
        ci = server::getinfo(cn);
        if(!ci) {
            PyErr_SetString(PyExc_ValueError, "Invalid cn specified");
            return 0;
    ...
    static PyObject *setBotLimit(PyObject *self, PyObject *args) {
        int cn, limit;
        server::clientinfo *ci;
        if(!PyArg_ParseTuple(args, "ii", &cn, &limit)) return 0;
        ci = server::getinfo(cn);
        if(!ci) {
            PyErr_SetString(PyExc_ValueError, "Invalid cn specified");
            return 0;
    ...
    static PyObject *hashPass(PyObject *self, PyObject *args) {
        ...
        server::clientinfo *ci;
        string string;
        if(!PyArg_ParseTuple(args, "is", &cn, &pass)) return 0;
        ci = server::getinfo(cn);
        if(!ci) {
            PyErr_SetString(PyExc_ValueError, "Invalid cn specified");
            return 0;
    ...
    static PyObject *setPaused(PyObject *self, PyObject *args) {
        bool val;
        if(!PyArg_ParseTuple(args, "b", &val)) return 0;
    ...
    static PyObject *authChallenge(PyObject *self, PyObject *args) {
        ...
        char *chal;
        server::clientinfo *ci;
        if(!PyArg_ParseTuple(args, "iis", &cn, &id, &chal)) return 0;
        ci = server::getinfo(cn);
        if(!ci) {
            PyErr_SetString(PyExc_ValueError, "Invalid cn specified");
            return 0;
    ...
    */
    ...
    static PyObject *sendDemo(PyObject *self, PyObject *args) {
        int cn, num;
        server::clientinfo *ci;
        if(!PyArg_ParseTuple(args, "ii", &cn, &num)) return 0;
        ci = server::getinfo(cn);
        if(!ci) {
            PyErr_SetString(PyExc_ValueError, "Invalid cn specified");
            return 0;
