#ifndef _SHARED_ENTS_H
#define _SHARED_ENTS_H
...
struct physent                                  // base entity type, can be affected by physics
{
    ...
    physent() : o(0, 0, 0), deltapos(0, 0, 0), newpos(0, 0, 0), yaw(0), pitch(0), roll(0), maxspeed(100), 
               ...
               blocked(false),
               p_gravity(200.0f), p_friction(6.0f), p_jumpvel(125.0f), p_playerspeed(100.0f), p_yaw(0.0f), p_pitch(0.0f), p_move_x(0.0f), p_move_y(0.0f), p_move_z(0.0f), p_inertia(0.0f), p_steercontrol(0.0f)
               { reset(); }
